...
### Fix Bug Jquery Security
jQuery updated from version 3.3.x to 3.7.1
Fixed alerts for the .ui-growl of the growl component
...
Visit my profile: [Matheus Ribeiro](https://www.linkedin.com/in/theusribeiro/).
